#!/bin/sh
test -f '/etc/redis/redis.conf' || cp -a /etc/redis_default/redis.conf /etc/redis/redis.conf
test -f '/etc/redis/redis.conf.default' || cp -a /etc/redis_default/redis.conf /etc/redis/redis.conf.default
